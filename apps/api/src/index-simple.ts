...
const mockStories = [
  {
    ...
    excerpt:
      "Мой путь в мир японской субкультуры лолита начался с простого любопытства к необычной моде...",
  ...
  },
  {
    ...
    excerpt:
      "Рассказываю о своем первом координате в стиле лолита и о том, какие ошибки я совершила...",
  ...
  },
  {
    ...
    excerpt:
      "Подробный разбор одного из самых популярных направлений лолиты - Sweet Lolita стиля...",
    ...
    swagger({
      documentation: {
        info: {
          ...
          version: "1.0.0",
          description:
            "API для системы заказов YuYu Lolita Shopping (Simplified)",
        },
      },
    }),
  )
      ...
      faqs: [
        {
          ...
          answer:
            "Для оформления заказа выберите понравившиеся товары, заполните форму с контактными данными и способом доставки.",
        },
        {
          id: 2,
          question: "Сколько времени займет доставка?",
          answer:
            "Доставка обычно занимает 7-14 дней в зависимости от выбранного способа доставки.",
        },
        {
          id: 3,
          question: "Можно ли вернуть товар?",
          answer:
            "Да, возврат товара возможен в течение 14 дней с момента получения при условии сохранения товарного вида.",
        },
      ],
    },
  }))
...
app.listen(port, () => {
  console.log(
    `🚀 YuYu Lolita Shopping API (Simplified) is running on http://${host}:${port}`,
  );
