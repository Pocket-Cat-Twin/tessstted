...
export const monitoringRoutes = new Elysia({ prefix: '/monitoring' })
  ...
  .get('/health', async () => {
    ...
    detail: {
      ...
      description: 'Returns system health status including database, memory, and performance metrics',
    },
  })
      ...
      app
        .get('/metrics', () => {
          ...
          detail: {
            ...
            description: 'Returns detailed application metrics including requests, errors, performance, and business metrics',
          },
        })
        ...
        .get('/metrics/summary', () => {
          ...
          return {
            ...
            data: {
              ...
              overview: {
                ...
                slowRequestPercentage: metrics.performance.slowRequestPercentage,
              },
              status: {
                healthy: metrics.errors.errorRate < 5 && metrics.performance.averageResponseTime < 1000,
                warnings: []
              }
            },
          };
          ...
          detail: {
            ...
            description: 'Returns a summarized view of key application metrics',
          },
        })
        ...
        .get('/metrics/business', () => {
          ...
          detail: {
            ...
            description: 'Returns business-related metrics including orders, revenue, and authentication',
          },
        })
  );
