      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div class="space-y-4">
          <div class="flex items-center space-x-2">
            ...
            <span class="text-xl font-bold">YuYu Lolita</span>
          </div>
          <p class="text-gray-300 text-sm leading-relaxed">
            {config.site_description || 'Заказы товаров из Китая с доставкой в Россию. Быстро, надежно, выгодно.'}
          </p>
        </div>
        ...
        <div class="space-y-4">
          ...
          <nav class="space-y-2">
            ...
            <a href="/create" class="block text-gray-300 hover:text-white transition-colors text-sm">
              Создать заказ
            </a>
            <a href="/track" class="block text-gray-300 hover:text-white transition-colors text-sm">
              Отследить заказ
            </a>
            <a href="/stories" class="block text-gray-300 hover:text-white transition-colors text-sm">
              Истории
            </a>
            <a href="/faq" class="block text-gray-300 hover:text-white transition-colors text-sm">
              FAQ
            </a>
          </nav>
        </div>
        ...
        <!-- Support -->
        <div class="space-y-4">
          <h3 class="text-lg font-semibold">Поддержка</h3>
          <div class="space-y-2">
            {#if config.contact_email}
              <a 
                href="mailto:{config.contact_email}" 
                class="flex items-center space-x-2 text-gray-300 hover:text-white transition-colors text-sm"
              >
          ...
          <div class="flex space-x-4">
            {#if config.telegram_link}
              <a 
                ...
                class="w-10 h-10 bg-gray-800 hover:bg-primary-600 rounded-lg flex items-center justify-center transition-colors"
                title="Telegram"
              >
    ...
    <div class="border-t border-gray-800 py-6">
      <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
        <div class="text-gray-400 text-sm">
          © {currentYear} {config.site_name || 'YuYu Lolita Shopping'}. Все права защищены.
        </div>
