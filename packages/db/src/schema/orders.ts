import { pgTable, uuid, varchar, text, timestamp, numeric, integer, pgEnum, boolean } from 'drizzle-orm/pg-core';
...
export const orders = pgTable('orders', {
  ...
  deliveryCost: numeric('delivery_cost', { precision: 10, scale: 2 }).default('0').notNull(),
