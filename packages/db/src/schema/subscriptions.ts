...
export const subscriptionFeatures = pgTable("subscription_features", {
  ...
  canParticipateInPromotions: boolean("can_participate_in_promotions")
    .default(false)
    .notNull(),
  canCombineOrders: boolean("can_combine_orders").default(false).notNull(),
  hasPriorityProcessing: boolean("has_priority_processing")
    .default(false)
    .notNull(),
  hasPersonalSupport: boolean("has_personal_support").default(false).notNull(),
  hasProductInspection: boolean("has_product_inspection")
    .default(false)
    .notNull(),
...
export const insertSubscriptionFeatureSchema =
  createInsertSchema(subscriptionFeatures);
export const selectSubscriptionFeatureSchema =
  createSelectSchema(subscriptionFeatures);
export const insertSubscriptionHistorySchema =
  createInsertSchema(subscriptionHistory);
export const selectSubscriptionHistorySchema =
  createSelectSchema(subscriptionHistory);
