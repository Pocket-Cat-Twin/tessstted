...
export const insertVerificationRateLimitSchema = createInsertSchema(verificationRateLimit);
export const selectVerificationRateLimitSchema = createSelectSchema(verificationRateLimit);
...
export type NewVerificationRateLimit = typeof verificationRateLimit.$inferInsert;