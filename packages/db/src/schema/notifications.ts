...
export const notificationHistory = pgTable('notification_history', {
  ...
  scheduledForIdx: index('notification_history_scheduled_for_idx').on(table.scheduledFor),
  createdAtIdx: index('notification_history_created_at_idx').on(table.createdAt),
  
  // Composite indexes
  userTypeIdx: index('notification_history_user_type_idx').on(table.userId, table.type),
  subscriptionNotificationIdx: index('notification_history_subscription_idx').on(table.subscriptionId, table.type),
}));
...
export const notificationPreferences = pgTable('notification_preferences', {
  ...
  promotionNotifications: boolean('promotion_notifications').default(false).notNull(),
