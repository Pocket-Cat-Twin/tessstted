...
export const insertStoryCategoryRelationSchema = createInsertSchema(
  storyCategoryRelations,
);
export const selectStoryCategoryRelationSchema = createSelectSchema(
  storyCategoryRelations,
);
...
export const insertStoryTagRelationSchema =
  createInsertSchema(storyTagRelations);
export const selectStoryTagRelationSchema =
  createSelectSchema(storyTagRelations);

// Types
export type BlogCategory = typeof blogCategories.$inferSelect;
export type NewBlogCategory = typeof blogCategories.$inferInsert;
export type StoryCategoryRelation = typeof storyCategoryRelations.$inferSelect;
export type NewStoryCategoryRelation =
  typeof storyCategoryRelations.$inferInsert;
